...
catalog-postgresql -A -i -a <account> -d <database> \
-n <catalogName> -o "/dwcc-output" -p <port> \
-s <server> -u <user>

# help - https://docs.data.world/en/59261-59392-Connect-to-data.html#UUID-801b1728-2649-145f-ac43-3a02dfe8dbc6
...
# dwcc commands
## catalog-postgresql = tell dwcc to catalog a postgressql database
